...
namespace GeminiCommerce\Order;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://dom.api.gogemini.io';
    ...
    {
        $report  = 'PHP SDK (GeminiCommerce\Order) Debug Report:' . PHP_EOL;
