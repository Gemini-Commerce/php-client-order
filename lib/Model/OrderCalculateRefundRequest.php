...
/**
 * OrderCalculateRefundRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Order
 * @author   OpenAPI Generator team
 ...
 */
class OrderCalculateRefundRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orderCalculateRefundRequest';
    ...
    protected static $openAPITypes = [
        'tenant_id' => 'string',
        'payment_id' => 'string',
        'items' => '\GeminiCommerce\Order\Model\OrderRefundItem[]',
        'shipping' => 'bool'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \GeminiCommerce\Order\Model\OrderRefundItem[]|null
     */
     ...
     * Sets items
     *
     * @param \GeminiCommerce\Order\Model\OrderRefundItem[]|null $items items
     *
     * @return self
     */
     ...
     * Sets shipping
     *
     * @param bool|null $shipping Boolean indicating whether to calculate refund for shipping.
     *
     * @return self
     */
