...
/**
 * OrderListOrdersByCustomerResponse Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Order
 * @author   OpenAPI Generator team
 ...
 */
class OrderListOrdersByCustomerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orderListOrdersByCustomerResponse';
    ...
    protected static $openAPITypes = [
        'orders' => '\GeminiCommerce\Order\Model\OrderOrderData[]',
    ...
    */
     ...
     * Gets orders
     *
     * @return \GeminiCommerce\Order\Model\OrderOrderData[]|null
     */
     ...
     * Sets orders
     *
     * @param \GeminiCommerce\Order\Model\OrderOrderData[]|null $orders orders
     *
     * @return self
     */
     ...
     *
     * @param string|null $next_page_token A token that can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages.
     *
     * @return self
     */
