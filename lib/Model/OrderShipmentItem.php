...
/**
 * OrderShipmentItem Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Order
 * @author   OpenAPI Generator team
 ...
 */
class OrderShipmentItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orderShipmentItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('row_weight', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets row_weight
     *
     * @param string|null $row_weight row_weight
     *
     * @return self
     */
    public function setRowWeight($row_weight)
    {
        if (is_null($row_weight)) {
            throw new \InvalidArgumentException('non-nullable row_weight cannot be null');
        }
