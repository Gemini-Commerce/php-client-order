...
class OrderUpdateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'tenant_id' => 'string',
        'id' => 'string',
        'payload' => '\OpenAPI\Client\Model\UpdateOrderRequestPayload',
        'field_mask' => 'string'
    ];
    ...
    */
     ...
     * Gets payload
     *
     * @return \OpenAPI\Client\Model\UpdateOrderRequestPayload|null
     */
     ...
     * Sets payload
     *
     * @param \OpenAPI\Client\Model\UpdateOrderRequestPayload|null $payload payload
     *
     * @return self
     */
