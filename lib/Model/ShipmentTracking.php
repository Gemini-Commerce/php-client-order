...
/**
 * ShipmentTracking Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Order
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentTracking';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('carrier_title', $data ?? [], null);
    ...
    */
     ...
     * Sets carrier_title
     *
     * @param string|null $carrier_title carrier_title
     *
     * @return self
     */
    public function setCarrierTitle($carrier_title)
    {
        if (is_null($carrier_title)) {
            throw new \InvalidArgumentException('non-nullable carrier_title cannot be null');
        }
